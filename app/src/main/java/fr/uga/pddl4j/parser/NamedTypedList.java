...
public class NamedTypedList implements Serializable {
    ...
    /**
     * Mes -------- The flag to tells if it is perceivable
     */
    private boolean isPerceivable = false;
    ...
    public String toString() {
        ...
        str.append(")");
        if(this.isPerceivable) str.append(" :isPerceivable");		//Mes
	...
	public void setPerceivable(boolean isPerceivable) {
		this.isPerceivable = isPerceivable;
	}
}
