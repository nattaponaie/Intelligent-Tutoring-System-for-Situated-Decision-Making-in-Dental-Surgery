...
public class Op implements Serializable {
     ...
     */
    public Op(final Symbol name, final List<TypedSymbol> parameters, final Exp preconds, final Exp desired_outcomes, final Exp effects) {
        this(name, parameters, preconds, desired_outcomes, effects, null);
    }
     ...
     *                              null.
     */
    public Op(final Symbol name, final List<TypedSymbol> parameters, final Exp preconditions, final Exp desired_outcomes, final Exp effects,
              final Exp duration) {
        this();
    ...
    public String toString() {
        ...
        str.append("\n  ").append(this.preconditions.toString());
