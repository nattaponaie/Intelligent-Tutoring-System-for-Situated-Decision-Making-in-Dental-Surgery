...
public class Domain implements Serializable {
    ...
    //Nui
    //private List<DomainRuleImplication> domain_rules;
    private List<DomainAxiom> domain_axioms;
    ...
    //Nui Test ---------------------------
/*    public Symbol nui = null;
    
    public void setNui( Symbol name )
    {
    	nui = name;
    }
    
    public Symbol getNui( Symbol name )
    {
    	return nui;
    }
*/
    ...
    public Domain(final Symbol name) {
        ...
        //this.domain_rules = new ArrayList<>();		//Nui: domain_rules 
        this.domain_axioms = new ArrayList<>();			//Nui: domain_axioms, use this instead of domain_rules
    ...
    public final List<DomainAxiom> getDomainAxioms() {
        return this.domain_axioms;
    }
    
    
    //Nui use domain axiom instead of domainRules
    /*public final List<DomainRuleImplication> getDomainRules() {
    ...
    //NUi
    //Add domain-Axiom
    public final boolean addDomainAxiom(final DomainAxiom dax ) {
        if (dax == null) {
            throw new NullPointerException();
        }
        return this.domain_axioms.add(dax);
    }
    
    //NOTE: Use domain axiom instead of  domain Rules
    /*public final boolean addDomainRule(final DomainRuleImplication domain_rule) {
        if (domain_rule == null) {
            throw new NullPointerException();
        }
        return this.domain_rules.add(domain_rule);
    }*/
     ...
     */
    //----------------------------------------------------------------------------------------
    // TODO: Nui: When adding domain rules, I haven't add it here. I am not sure what it is. 
    //----------------------------------------------------------------------------------------
    ...
    public String toString() {
        ...
        //Nui Domain Rules
        //-----------------------------------------
        /*if (!this.domain_rules.isEmpty()) {
            str.append("(:domain_rules");
            for (DomainRuleImplication p : this.domain_rules) {
                str.append("\n  ").append(p);
            }
            str.append("\n)\n");
        }*/
        
        if (!this.domain_axioms.isEmpty() ) 
        {
        	str.append("(:axiom");
        	for (DomainAxiom p : this.domain_axioms) {
                str.append("\n  ").append(p);
            }
            str.append("\n)\n");
        }
