...
public enum Connective {
	...
	/**
     * The connective for the disjunctive expressions or may occur.
     */
    //Mes added ONE_OF
    ONEOF("oneof"),
    
    /**
     *  The probability value to describe weight of each element in ONEOF
     */
    // Mes added probability Connective
    PROBABILITY_ATOM(""),
    
    /**
     *  The connective for sequence in Procedure
     */
    //Mes added SEQUENCE
    SEQUENCE("sequence"),
    
    /**
     *  The connective for if condition in Procedure (works like "WHEN" but can have "else" statement)
     */
    // Mes added IF
    IF("if"),
    
    /**
     *  The connective for sequential action
     */
    ACTION("action"),
